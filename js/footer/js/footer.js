...
(function () {
   ...
   footerContent ='<div class="footerWrap"><div class="footer screenCenter"><a class="footerLogo"href="http://#/"target="_blank"></a><div class="footerNav"><a href="http://#/"target="_blank"title="Lar">Главная</a>|<a href="http://#/"title="Vicky"target="_blank">Vicky</a>|<a href="http://#/"target="_blank"title="Вк">Вк</a>|<a href="http://#/"target="_blank"title="Fórum">Fórum</a><p class="wenww">'+footerWww+'</p><p>DDTank2 <em>Version 0.0</em></p><div class="footerTips">Private Server<br>Этот сервер создавался для игроков и любителей:)</div></div><a href="'+rfidHref+'" class="game_rfid" style="display:'+rfidShow+'" target="_blank">&#160;</a></div></div>'
