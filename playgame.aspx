...
<title>DDtank2 launcher</title>
    <link rel="shortcut icon" href="images/favicon.jpg"> 
    <script type="text/javascript" src="js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="js/dandantang.js"></script>
    <script type="text/javascript" src="js/rightClick.js"></script>
    <script type="text/javascript" src="js/swfobject.js"></script>
    <script type="text/javascript" src="js/isSafeFlash.js"></script>
	<script type="text/javascript" src="js/popup/prototype.js"></script>
    <script type="text/javascript" src="js/popup/script/popup.js"></script>
